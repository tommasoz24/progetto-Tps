...
/** Okno rozpoczętej gry Reversi 
 * @author Bartosz Ruta
 *
 */
public class OknoGra extends JFrame {
	/** ContentPane dla okna
	 * 
	 */
	public JPanel contentPane;
	/** Panel zawierający plansze do gry
	 * 
	 */
	public PanelPlansza plansza;
	/** Panel zawierający czat
	 * 
	 */
	public OknoCzat czat;
	...
	public OknoGra(boolean czarny) {
		...
		czat = new OknoCzat();
		JScrollPane czatIscrollbar = new JScrollPane(czat,ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		c.fill = GridBagConstraints.BOTH;
		c.weightx = 0.2;
		c.weighty = 0.9;
		c.gridwidth = 1; 
		...
		//scrollbar.setViewportView(czat);
		//czat.wyswietlWiadomosc("ASDASDADS");
	}
